...
/** One figure in the row's mini-grid. */
...
/**
 * One player's line in the leaderboard: rank + name, a win-rate bar, and the
 * averaged figures (games, wins, mean score, mean turn). The rank medal colours
 * the top three.
 */
