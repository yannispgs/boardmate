 ...
 * fade that shows it, and the button that caused it. « Phase terminée → » is
 * disabled while the write is in flight, but the fade runs *after* the reload
 * comes back, and a second tap in that window would close the next phase
 * before anybody had seen it open.
 *
