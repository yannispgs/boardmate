 ...
 * would let two players be read on two different sets of evenings side by side,
  ...
  return (
    <section className="flex flex-col gap-4">
      <p className="text-center text-sm text-zinc-500 dark:text-zinc-400">
        Chacun face à ses propres parties sur ce jeu : le curseur est ce soir,
        les points gris ses soirées d&apos;avant.
      </p>
